    ...
    <div>
      ...
      {data ? (
        <>
          ...
          <Card title={t`Daily reach`} subtitle={rangeLabel[range]} className="mt-4">
            <LineChart
              height={200}
              labels={data.daily.map((day) => day.day.slice(5))}
              series={[{ name: t`Reach`, values: data.daily.map((day) => day.reach), area: true }]}
            />
          </Card>
            ...
            <Card
              ...
              right={
                <span className="text-right">
                  ...
                  <span className="text-[10.5px] uppercase tracking-[0.08em] text-[#6E6975]">
            ...
            >
              <ColumnBars
                ...
                bars={data.daily.map((day) => ({
                  ...
                  value: day.newFollowers ?? 0,
                }))}
              />
            </Card>
            <Card title={t`Top posts`} subtitle={t`By reach`}>
                  ...
                  {data.topPosts.map((post) => (
                    ...
                    >
                      <div className="min-w-0">
                        ...
                        <p className="mt-1 flex flex-wrap gap-x-2 text-[11px] text-[#6E6975] tabular-nums">
                      ...
                      <div className="shrink-0 text-right">
                        ...
                        <p className="text-[10px] uppercase tracking-wide text-[#6E6975]">
                          <Trans>Reach</Trans>
                        </p>
                      </div>
                    </li>
