      ...
      data: [
        {
          ...
          body: "Hi — this number hosts Manor personal agents. Some people in this group haven't texted this line yet; send any message to this number first if you want your own agent here.",
        },
      ],
      skipDuplicates: true,
    });
    ...
    data: [
      {
        ...
        body: `"${name}" was linked to your Manor line. Reply YES to let your agent join the conversation there, or NO to stay out.`,
      },
    ],
    skipDuplicates: true,
  });
