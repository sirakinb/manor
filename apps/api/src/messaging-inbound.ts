      ...
      data: [
        {
          ...
          body: "Hi. This line hosts Manor personal agents. Some people in this group haven't messaged it yet; send any message to this line first if you want your own agent here.",
        },
      ],
      skipDuplicates: true,
    });
    ...
    data: [
      {
        ...
        body: `"${name}" was linked to your Manor agent. Reply YES to let your agent join the conversation there, or NO to stay out.`,
      },
    ],
    skipDuplicates: true,
  });
